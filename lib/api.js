...
export const bookingsAPI = {
  ...
  markConfirmed: (id) => api.post(`/api/bookings/${id}/confirm`),
...
export const calendarAPI = {
  getMonthlyEvents: (year, month) => api.get(`/api/calendar/monthly?year=${year}&month=${month}`),
  getDayEvents: (date) => api.get(`/api/calendar/events?date=${date}`),
  getCalendarCounts: (year, month) => api.get(`/api/calendar?year=${year}&month=${month}`),
};
